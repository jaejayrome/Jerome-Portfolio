...
export default function Navbar() {
    return (
        <div className="flex flex-row text-lg justify-evenly p-4 text-white tablet:text-2xl overflow-hidden space-x-2">
            <div className="hover:bg-purple-400 rounded-xl px-2 py-6 bg-black shadow-purple-400 shadow-2xl mobile:px-6 mobile:py-10">
