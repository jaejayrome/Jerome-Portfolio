...
export const ThemeSwitcher = () => {
  ...
  return (
    <button
      className={`w-fit absolute right-0 top-0 p-4 mt-3 mr-6 tablet:mt-6 rounded-md hover:scale-110 active:scale-100 duration-200 bg-slate-200 dark:bg-slate-200 `}
      onClick={() => setTheme(theme === "dark" ? "light" : "dark")}
    >
        {theme === "dark" ?  <Image src = {ToggleLightModeButton} alt ="" className=""></Image> : 
